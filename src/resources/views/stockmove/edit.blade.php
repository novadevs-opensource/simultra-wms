...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item active">
        <a href="{{route('stockmove.create')}}">{{__('Edit stock move')}}</a>
    </li>
@endsection
        ...
        <div class="col-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form  role="form" method="POST" action="{{route('stockmove.update', $o->id) }}">
                        @method('PUT')
                        {{ csrf_field() }}
						<div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input type="number" name="qty" id="qty" class="form-control" value="{{$o->qty}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input type="text" name="description" id="description" class="form-control" value="{{$o->description}}">
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select name="picking_type" id="picking_type" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input type="date" name="expected_date" id="expected_date" class="form-control" value="{{$o->expected_date}}">
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input type="text" name="source" id="source" class="form-control" value="{{$o->source}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <input type="text" name="source_location" id="source_location" placeholder="Barcode..." class="form-control typeahead" value="{{$o->source_location}}"/>
                                        </div>
                                    </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <input type="text" name="destination_location" id="destination_location" placeholder="Barcode..." class="form-control typeahead" value="{{$o->destination_location}}"/>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5 col-sm-offset-2">
                                <a class="btn btn-white" href="{{route('stockmove.index')}}">{{__('Cancel')}}</a>
