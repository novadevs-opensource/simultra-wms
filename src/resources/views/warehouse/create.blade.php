...
<li class="breadcrumb-item active">
    <a href="{{route('warehouse.create')}}">{{__('New warehouse')}}</a>
</li>
@endsection
                ...
                <div class="ibox-content">
                    <form  role="form" method="POST" action="{{route('warehouse.store')}}">
						...
						<div class="form-group row">
							<label class="col-sm-2 col-form-label" for="name"><b>{{ __('Name') }}</b></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="name" id="name">
							</div>
                        </div>
                        <div class="form-group row">
							<label class="col-sm-2 col-form-label" for="shortname"><b>{{ __('Short name') }}</b></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="shortname" id="shortname">
							</div>
                        </div>
                        <div class="form-group row">
							<label class="col-sm-2 col-form-label" for="address"><b>{{ __('Address') }}</b></label>
							<div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5 col-sm-offset-2">
                                <a class="btn btn-white" href="{{route('warehouse.index')}}">{{__('Cancel')}}</a>
