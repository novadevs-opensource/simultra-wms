                            ...
                            <tbody>
                                @foreach ($o as $i)
                                    <tr>
                                        ...
                                        <td>{{$i->role}}</td>
                                        <td>{{$i->address}}</td>
                                        {{-- <td>{{$i->wh->name}} - {{$i->wh->shortname}}</td> --}}
                                        <td>
                                            <form action="{{route('partner.destroy', $i->id)}}" method="POST">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <a href="{{route('partner.show', $i->id)}}" class="btn btn-xs btn-primary">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                @if ( checkRole(Auth()->user()->role, 'ADMIN') )
                                                <a href="{{route('partner.edit', $i->id)}}" class="btn btn-xs btn-secondary">
