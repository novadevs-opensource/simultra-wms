...
@section('page-header') 
    {{__('Create')}} {{__('Company/Organisation')}} 
@endsection 
        ...
        <div class="col-12">
        	<div class="ibox ">
				...
				<div class="ibox-content">
					<form class="" role="form" method="POST" action="{{ route('setup.company.store') }}">
						{{ csrf_field() }}
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="profid1" id="profid1" class="form-control">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="profid2" id="profid2" class="form-control">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="profid3" id="profid3" class="form-control">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="profid4" id="profid4" class="form-control">
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-sm-4">
								<input type="radio" name="vat_in_use" id="use_vat">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								<input type="radio" name="vat_in_use" id="no_vat">
						...
						<div class="form-group row">
							<div class="col-sm-4">
								<input type="radio" name="localtax1_in_use" id="use_lt1">
								...
								<div class="form-group row">
									...
									<div class="col-12">
										<select id="use_lt1_val_1" class="form-control" name="localtax1_in_use_val_1">
											<option value="0">Sales - Purchases Local Taxes reports are calculated with the difference between localtaxes sales and localtaxes purchases</option>
											<option value="1">Purchases - Local Taxes reports are the total of localtaxes purchases</option>
											<option value="2">Sales - Local Taxes reports are the total of localtaxes sales</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="form-group row">
							<div class="col-sm-4">
								<input type="radio" name="localtax1_in_use" id="no_lt1">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4">
                                <input type="radio" name="localtax2_in_use" id="use_lt2">
