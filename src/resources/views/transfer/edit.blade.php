...
<li class="breadcrumb-item">
    <a href="{{route('transfer.index')}}">{{__('Transfers')}}</a>
</li>
<li class="breadcrumb-item active">
    <a href="{{route('transfer.edit', $o->id)}}">{{__('Edit transfer')}}</a>
</li>
@endsection
        ...
        <div class="col-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form  role="form" method="POST" action="{{route('transfer.update', $o->id)}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        @method('PUT')
						<div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input type="number" name="qty" id="qty" class="form-control @error('qty') is-invalid @enderror" value="{{$o->qty}}">
                                        @error('qty')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <select name="destination_location" id="destination_location" class="form-control">
                                                @foreach ($l as $i)
                                                    @if ($i->id == $o->destination_location)
                                                    <option value="{{$i->id}}" selected>{{$i->name}}</option>
                                                    @else
                                                    <option value="{{$i->id}}">{{$i->name}}</option>
                                                    @endif
                        ...
                        <div class="form-group row">
                            <div class="col-1">
                                @if ($o->status == 1)
                                    <input type="checkbox" name="status" id="status" class="form-control" checked="checked">
                                @else
                                    <input type="checkbox" name="status" id="status" class="form-control">
                                @endif
                            </div>
                            <label for="status" class="col-4 col-form-label">{{__('Trasfer finished? Y/N')}}</label>
                        </div>
